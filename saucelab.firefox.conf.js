...
const buildTitle = 'Sauce Labs BMC Automation Testing in Firefox.';
...
exports.config = {
    ...
    multiCapabilities: [{
        ...
        timeouts: {implicit: 190000.0, pageLoad: 600000.0, script: 30000.0}
    }],
    ...
    var printSessionId = function (jobName) {
        browser.getSession().then(function (session) {
            console.log('SauceOnDemandSessionID=' + session.getId() + ' job-name=' + buildTitle);
