...
let tc_name = 'TC_Megamenu_Products_How_to_Advice';

describe('STORY: MEGAMENU PRODUCTS HOW TO ADVICE', () => {
    ...
    it(test_data.tc_description, () => {
        ...
        executeStep('STEP ' + global.step_counter++ + ': CLICK LINK: PRODUCTS HOW TO & ADVICE', () => {
            CommonSteps.click_megamenu_products_model_menu_item_link(common_data.megamenu_products_index.how_to_advice);
        });
        executeStep('ASSERT ' + global.assert_counter++ + ': URL ENDPOINT', () => {
            assert.end_point(localized_data.navigation_endpoint.how_to_advice);
        });
