...
let tc_name = 'TC_Main_Menu_Products';
...
describe('STORY: MAIN MENU', () => {
    ...
    it(test_data.tc_description, () => {
        ...
        executeStep('STEP ' + global.step_counter++ + ': CLICK LINK: PRODUCTS', () => {
            CommonSteps.click_main_menu_link(common_data.main_menu_index.products);
        });
