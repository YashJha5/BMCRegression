...
let tc_name = 'TC_Megamenu_Ideas_Exteriors';

describe('STORY: MEGAMENU IDEAS EXTERIORS', () => {
    ...
    it(test_data.tc_description, () => {
        ...
        executeStep('STEP ' + global.step_counter++ + ': CLICK LINK: IDEAS EXTERIORS', () => {
            CommonSteps.click_megamenu_ideas_model_menu_item_link(common_data.megamenu_ideas_index.exteriors);
        });
        executeStep('ASSERT ' + global.assert_counter++ + ': URL ENDPOINT', () => {
            assert.end_point(localized_data.navigation_endpoint.exteriors);
        });
