...
let tc_name = 'TC_Megamenu_Ideas_Overview';

describe('STORY: MEGAMENU IDEAS OVERVIEW', () => {
    ...
    it(test_data.tc_description, () => {
        ...
        executeStep('STEP ' + global.step_counter++ + ': CLICK LINK: IDEAS OVERVIEW', () => {
            CommonSteps.click_megamenu_ideas_model_menu_item_link(common_data.megamenu_ideas_index.overview);
        });
        executeStep('ASSERT ' + global.assert_counter++ + ': URL ENDPOINT', () => {
            assert.end_point(localized_data.navigation_endpoint.ideas);
        });
