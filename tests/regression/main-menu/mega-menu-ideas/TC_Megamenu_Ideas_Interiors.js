...
let tc_name = 'TC_Megamenu_Ideas_Interiors';

describe('STORY: MEGAMENU IDEAS INTERIORS', () => {
    ...
    it(test_data.tc_description, () => {
        ...
        executeStep('STEP ' + global.step_counter++ + ': CLICK LINK: IDEAS INTERIORS', () => {
            CommonSteps.click_megamenu_ideas_model_menu_item_link(common_data.megamenu_ideas_index.interiors);
        });
        executeStep('ASSERT ' + global.assert_counter++ + ': URL ENDPOINT', () => {
            assert.end_point(localized_data.navigation_endpoint.interiors);
        });
