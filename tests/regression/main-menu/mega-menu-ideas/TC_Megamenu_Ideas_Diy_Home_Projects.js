...
let tc_name = 'TC_Megamenu_Ideas_Diy_Home_Projects';

describe('STORY: MEGAMENU IDEAS DIY HOME PROJECTS', () => {
    ...
    it(test_data.tc_description, () => {
        ...
        executeStep('STEP ' + global.step_counter++ + ': CLICK LINK: IDEAS DIY HOME PROJECTS', () => {
            CommonSteps.click_megamenu_ideas_model_menu_item_link(common_data.megamenu_ideas_index.diy_paint_products);
        });
        executeStep('ASSERT ' + global.assert_counter++ + ': URL ENDPOINT', () => {
            assert.end_point(localized_data.navigation_endpoint.diy_home_projects);
        });
